...
The whole process and its description might be lengthy. So here is a TL;DR or a Table of Contents for your reference.
...
**Android Client**: We have just submitted our Android app to Play Store and it is currently under review :)
