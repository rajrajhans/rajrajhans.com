---
title: "CSS for Beginners Series #2 : Pricing Tables using CSS"
date: "2018-07-28"
...
![CSS for Beginners Series #1](css-series-2-wide.png "CSS for Beginners Series #1 : Fancy Buttons using CSS")

<Alert><ExtLink link={"https://rajrajhans.com/rajrajhans_assets/css-series-2.zip"} title={"Download code files"}>Click here to download the code files for this post</ExtLink></Alert>
