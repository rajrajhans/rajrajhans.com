...
date: "2020-07-30"
description: I wanted to implement a contact form on my website. However, Gatsby sites are a static sites. In this post, we will use Netlify's Lamba Functions with SendGrid API to implement a contact form.
