            ...
            <div className="aboutRaj">
              <div className="aboutRajText">
                ...
                <div className="aboutRajTextContent">
                  <p>
                    Raj is a Second Year Computer Engineering student at VIT, Pune. A tech-aficionado, as he likes to
                    put it, Raj is also a freelance web designer and developer.
                  </p>

                  <p>
                    As an aspiring software developer, you will find him speaking computerese, barely comprehensible to
                    anyone else.
                    But don’t let his overtly composed and calm visible delude you. He can easily grab your attention
                  ...
                  <p>
                    When not raising pull requests on GitHub, you will find him lost in a world of thriller books and
                    soothing music.
                  </p>
                </div>
              </div>
            ...
            <div className="aboutBlog">
              ...
              <div className="aboutBlogText">
                ...
                <div className="aboutBlogTextContent">
                  ...
                  <p>
                    Blogging is a way to document one’s learnings. If you haven’t, go watch <a
                    href={"https://www.youtube.com/watch?v=RVKofRN1dyI"} target={"_blank"} rel={"noopener noreferrer"}
                    title={"GaryVee's Youtube video"}> Gary Vaynerchuk’s Document, Don’t Create video.</a>
                  </p>

                  <p>
                    Developers are creators, and documenting the creating process only improves the developer’s skills.
                    Writing about something solidifies the learning process. It’s easy to say you’ve done some reading
                    on X, but if you have a blog post and a GitHub project to back up, it really makes it more
                    believable. Not just that, it has the potential to help someone. A small contribution is always
                    better than no contribution.
                  </p>
