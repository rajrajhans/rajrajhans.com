...
<Alert><ExtLink link={"http://assets.rajrajhans.com/css-series-3.zip"} title={"Download code files"}>Click here to download the code files for this post</ExtLink></Alert>
