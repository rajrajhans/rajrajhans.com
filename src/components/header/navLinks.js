  ...
  render() {
    return (
      <ul className={"ul_nav_bar"}>
        ...
        <li className={"navBarLinkListItem"}>
          <a href={"https://drive.google.com/file/d/1I51JpWSuuhLxEspwByE0XQfO4nt3CFCP/view?usp=sharing"} rel={"noopener noreferrer"} title={"Raj's resume"} target={"_blank"}>Resume</a>
        </li>
