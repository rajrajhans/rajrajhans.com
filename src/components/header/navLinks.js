  ...
  render() {
    return (
      <ul className={"ul_nav_bar"}>
        ...
        <li className={"navBarLinkListItem"}>
          <a href={"https://drive.google.com/file/d/1129jiFM3Fx0eG6Z6TCHnwgB4LT8TjSpd/view?usp=sharing"} rel={"noopener noreferrer"} title={"Raj's resume"} target={"_blank"}>Resume</a>
        </li>
