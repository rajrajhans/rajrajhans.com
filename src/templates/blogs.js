...
const Blogs = (props) => {
  ...
  const { first, last, index } = props.pageContext;
  const previousUrl =
    index - 1 === 1 ? "/blogs" : `/blogs/${(index - 1).toString()}`;
  const nextUrl = `/blogs/${(index + 1).toString()}`;
  ...
  return (
    <Layout location={props.location}>
      <SEO
        ...
        url={"/blogs"}
      />
      <HerosectionPage title={` All Posts`} svg={<BlogsSVG />} />
      ...
      <div className="homeBlogGrid">
        ...
        <div className="homeBlogHeadingBox">
          ...
          <div className="homeBlogArchivesLink">
            <InternalLink link={"/archives"} title={"Explore by Categories"}>
        ...
        <div className="homeBlogBoxesCntnr">
          {posts.map((post, id) => {
            return <BlogPostBox blog={post.node} id={id} />;
          })}
        </div>
      </div>
      ...
      <div className="nextLink">
        <PaginationLink test={last} url={nextUrl} text="Go to Next Page" />
      </div>
          ...
          {!first ? (
            <Link to={previousUrl}>
              <div className={"blogPrevCntnr"}>
                <PrevIcon classname={"blogPrevSVG"} />
                &nbsp; Previous Page
              </div>
            </Link>
          ) : null}
          ...
          {!last ? (
            <Link to={nextUrl}>
              <div className={"blogNextCntnr"}>
                Next Page &nbsp;
                <NextIcon classname={"blogNextSVG"} />
              </div>
            </Link>
          ) : null}
        </div>
  ...
  >
    <defs>
      ...
      <linearGradient
        ...
        x2="1059.46"
        y2="468.94"
        xlinkHref="#969f2d34-5bff-4fc3-8c31-c6509eddc389"
      />
      <linearGradient
    ...
    <rect
      ...
      fill="#3355ff"
    />
    <rect x="886.13" y="652.15" width="103.43" height="7.86" fill="#3355ff" />
    <rect x="868.55" y="668.74" width="142.32" height="7.86" fill="#3355ff" />
    <rect x="868.55" y="686.2" width="142.32" height="7.86" fill="#3355ff" />
    <rect x="868.55" y="703.66" width="142.32" height="7.86" fill="#3355ff" />
    <rect
      y="482.59"
      width="426.61"
      height="208.22"
    ...
    <rect
      ...
      fill="#3355ff"
    />
    <rect x="87.15" y="583.32" width="243.53" height="7.86" fill="#3355ff" />
    <rect x="45.75" y="599.91" width="335.1" height="7.86" fill="#3355ff" />
    <rect x="45.75" y="617.37" width="335.1" height="7.86" fill="#3355ff" />
    <rect x="45.75" y="634.83" width="335.1" height="7.86" fill="#3355ff" />
    <path
